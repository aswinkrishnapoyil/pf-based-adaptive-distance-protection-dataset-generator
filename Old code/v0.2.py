...
def get_case_feature_row_for_corridor(
    ...
    d_row = {
        ...
        "zone1_total_ikss_contribution_ratio": d_zone1_infeed_summary.get(
            "total_ikss_contribution_ratio",
            0.0,
        ),
        "zone1_max_single_ikss_contribution_ratio": d_zone1_infeed_summary.get(
        ...
        "zone2_total_ikss_contribution_ratio": d_zone2_infeed_summary.get(
            "total_ikss_contribution_ratio",
            0.0,
        ),
        "zone2_max_single_ikss_contribution_ratio": d_zone2_infeed_summary.get(
            "max_single_ikss_contribution_ratio",
            0.0,
        ),
...
def main():
    ...
    _print("\n" + "=" * 80)
    _print(
        "v0.2 - Unified corridor-based feature matrix "
